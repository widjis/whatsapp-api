...
class LIDMappingManager {
  ...
  async processContactFromMessage(message, chatId) {
    ...
    console.log(`=== MESSAGE CONTACT PROCESSING ===`);
    ...
    console.log(`=== END MESSAGE CONTACT PROCESSING ===`);
  ...
  storeContactInfo(contactInfo) {
    ...
    console.log(`=== STORE CONTACT INFO ===`);
    ...
    console.log(`Existing Contact:`, existingContact ? JSON.stringify(existingContact, null, 2) : 'None');
    ...
    console.log(`✅ Stored contact in database:`, JSON.stringify(contactInfo, null, 2));
    ...
    if (contactInfo.pushName) {
      ...
      if (lid) {
        ...
        if (id === lidContactId && phoneContactId !== id) {
          ...
          console.log(`=== PUSHNAME SYNC DETAILS ===`);
          console.log(`From Contact (LID):`, JSON.stringify(contactInfo, null, 2));
          console.log(`To Contact ID:`, phoneContactId);
          console.log(`=== END SYNC DETAILS ===`);
        }
        ...
        if (id === phoneContactId && lidContactId !== id) {
          ...
          console.log(`=== PUSHNAME SYNC DETAILS ===`);
          console.log(`From Contact (Phone):`, JSON.stringify(contactInfo, null, 2));
          console.log(`To Contact ID:`, lidContactId);
          console.log(`=== END SYNC DETAILS ===`);
        }
      }
    }
    ...
    console.log(`=== END STORE CONTACT INFO ===`);
  }
  ...
  getCorrectPushName(senderId, fallbackPushName = null) {
    if (!senderId) return fallbackPushName || 'Unknown';
    ...
    if (this.pushNameMapping.has(senderId)) {
      return this.pushNameMapping.get(senderId);
    }
    ...
    if (phoneNumber && this.phoneToLidMapping.has(phoneNumber)) {
      ...
      if (this.pushNameMapping.has(lidContactId)) {
        return this.pushNameMapping.get(lidContactId);
      }
    }
